export default function NavBar() {
    return (
        <header className="flex justify-between py-2 px-3 h-16 bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-600 gap-6 fixed top-0 left-0 right-0 z-50">
